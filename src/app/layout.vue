    ...
    <main
      ...
      :class="
        cn(
          ...
          'bg-ccmkt-bg-white h-[100dvh] pt-[55px] overflow-y-auto m-auto flex flex-col gap-3 justify-start items-center px-5'
        )
      "
    >
      <slot />
...
const isHideHeader = computed(() => route.meta.header === false)
